    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-amber-50 to-orange-50 py-20">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            ...
            사고의 조각(Synap)으로 만드세요. 연결은 당신이 만듭니다.
          </p>
      ...
      <section className="py-20 max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              title: "음성 기록 & Synap 추출",
              desc: "대화를 음성으로 기록하면 AI가 인사이트 조각(Synap)을 자동으로 추출합니다. 더 이상 대화가 휘발되지 않습니다.",
              icon: "M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z",
            },
            {
              title: "Synap Board & 유추",
              desc: "축적된 Synap들을 살펴보고, 직접 연결하세요. 당신의 유추가 새로운 Synap이 되어 집단 사고를 확장합니다.",
              icon: "M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1",
            },
            {
              title: "토론 & 커뮤니티",
              desc: "책, 생각, 질문을 나누고 댓글로 깊이 있는 대화를 이어갑니다. 모든 토론에서 Synap이 태어납니다.",
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-8">
            {[
              ...
              {
                step: "2",
                title: "AI가 Synap을 추출한다",
                desc: "대화에서 유의미한 인사이트 조각(Synap)이 자동으로 추출되어 Synap Board에 쌓입니다.",
              },
              {
                step: "3",
                title: "당신이 연결한다",
                desc: "시간이 지나며 쌓인 Synap들 사이에서 유추를 발견하세요. 그 연결 자체가 새로운 Synap이 됩니다.",
              },
              {
                step: "4",
                title: "집단 사고가 진화한다",
                desc: "개인의 Synap, 그룹의 Synap, 연결된 유추가 모여 살아있는 지식 생태계가 탄생합니다.",
              },
            ].map((item) => (
      ...
      <section className="bg-amber-700 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-amber-100 mb-8">
            모든 대화에는 연결되기를 기다리는 Synap이 있습니다.
          </p>
          <Link
            href="/register"
